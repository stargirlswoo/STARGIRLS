/* STARGIRLS storefront gallery: prefer real garment previews; remove HAYATI artwork hero. */
(function(){
  ...
  const trimHayatiHero=(product,images)=>isHayati(product)&&images.length>1?images.slice(1):images;
